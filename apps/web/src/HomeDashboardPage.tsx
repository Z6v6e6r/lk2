...
export function HomeDashboardPage({
  ...
  const shellClassName = [
    'figma-home-shell',
    layoutVariant === 'v3' ? 'is-home-v3' : null,
  ...
  const heroPromotion = promotionSlots ? (
    <HomePromotionCarousel promotion={null} promotions={promotionSlots.hero} variant="hero" />
  ) : (
    <section className="fh-hero-promotion fh-section-unavailable" role="alert">
        ...
        <section className="fh-main-box">
              ...
              <div className="fh-for-me">
                ...
                {bookingRecommendations ? (
                  <BookingRecommendations
                    ...
                    compact
                    compactActionVariant={layoutVariant === 'v3' ? 'mini-create' : 'default'}
                    compactMetadataVariant={layoutVariant === 'v3' ? 'station-time' : 'default'}
                    compactRosterVariant={layoutVariant === 'v3' ? 'host-slots' : 'default'}
                    showCompactReasonBadges={layoutVariant !== 'v3'}
          ...
          {layoutVariant === 'v3' ? null : (
            <>
              {promotionSlots ? (
                <>
                  {dashboard.promotions.status === 'STALE' ? (
                    <p className="fh-section-stale" role="status">
                ...
                <section className="fh-locations" aria-labelledby="fh-locations-title">
                  ...
                  <div className="fh-location-track">
                    {dashboard.locations.map((location, index) => {
                      const imageUrl =
                        location.imageUrl ?? (index === 0 ? locationSeligerUrl : null);
                      return (
                        <a
