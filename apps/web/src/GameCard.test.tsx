...
describe('GameCard lifecycle template', () => {
  ...
  it('uses only station and time metadata in the Home V3 compact variant', () => {
    render(
      <GameCard
        game={publicGame}
        compact
    ...
    expect(within(stationRow as HTMLElement).getByText('18:00–19:00')).toBeInTheDocument();
    ...
    expect(card.querySelectorAll('.game-card__meta svg')).toHaveLength(2);
  });
