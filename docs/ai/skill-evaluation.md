...
| Failure diagnosis and fix           | Reproduced `10 !== 0`, changed `                                                                                                                          |                                                                                       | `to`??`, reran focused check successfully.                                                                                                                        | Same red/green correction; skipped unrelated preview.                                                                               | Actual Node assertions cover zero, positive and missing totals only. |
...
- Installed CLI help/catalog/prompt diagnostics and an independent read-only execution probe.
