...
и видно, что устройство давно не подтверждалось и потому не является живым получателем. Показы и
открытия не учитываются: у service worker нет маяков, а «показано» на iOS не равно «прочитано».
