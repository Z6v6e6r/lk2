...
describe('Redis realtime ticket issuer', () => {
  it('stores one short-lived ticket id and keeps the credential out of Redis', async () => {
    const set = vi.fn().mockResolvedValue('OK');
    const issuer = new RedisRealtimeTicketIssuer({ set } as never, {
    ...
    expect(claims).toMatchObject({
      ...
      tenantId: '86afbe01-0318-4dd2-bc25-303b7bf0d430',
      tenantKey: 'local-padel',
      sub: '49d4e88c-7d52-4c1c-8f80-2fc99b42f9ca',
      sid: '55555555-5555-4555-8555-555555555555',
    });
    expect(typeof claims.jti).toBe('string');
    expect(set).toHaveBeenCalledWith(
      realtimeTicketRedisKey(claims.jti as string),
      'issued',
      'EX',
      30,
      'NX',
