...
export interface GiftCertificateMediaStore {
...
export interface S3GiftCertificateMediaStoreOptions {
...
export class S3GiftCertificateMediaStore implements GiftCertificateMediaStore {
  private readonly internalClient: S3Client;
  private readonly deliveryClient: S3Client;
  private ready: Promise<void> | undefined;

  public constructor(private readonly options: S3GiftCertificateMediaStoreOptions) {
    const shared = {
